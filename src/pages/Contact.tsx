      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-xs font-black text-red-600 uppercase tracking-[0.3em] mb-4 block">Get In Touch</span>
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 uppercase">Contact Us</h1>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">Have a question or need assistance? Our team is here to help you with anything you need.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-black tracking-tighter mb-1 uppercase">Phone</h3>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-black tracking-tighter mb-1 uppercase">Email</h3>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-black tracking-tighter mb-1 uppercase">Office</h3>
                  <p className="text-gray-500 text-sm">123 Fashion Street, Sector 7, Uttara, Dhaka, Bangladesh</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100">
                <h2 className="text-3xl font-black tracking-tighter mb-8 uppercase">Send a Message</h2>
